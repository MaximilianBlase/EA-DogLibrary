...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    set(eeprom_image ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENAME}.eep.hex)
    ...
    add_custom_target(
            ...
            -U efuse:w:${AVR_EX_FUSE}:m
            COMMENT "Setup: High Fuse: ${AVR_H_FUSE} Low Fuse: ${AVR_L_FUSE} Extended Fuse: ${AVR_EX_FUSE}"
    )
    ...
    add_custom_target(
            ...
            ${AVR_OBJDUMP} -h -S ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${elf_file}
            > ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${lst_file}
            DEPENDS ${elf_file}
    )
...
if(CMAKE_BUILD_TYPE MATCHES RelWithDebInfo)
    set(CMAKE_C_FLAGS_RELWITHDEBINFO "-Os -D_DEBUG_MODE=1")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-Os -D_DEBUG_MODE=1")
...
#add_definitions("-E") # Use to disable compiling and just precompile
